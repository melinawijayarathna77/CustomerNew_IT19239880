...
public class Cart {
	...
	//A common method to connect to the DB
		...
		// execute the statement
				...
				con.close();
				String newCarts = readCartDetails();
			...
			{ 
				output = "{\"status\":\"error\", \"data\":\"Error while inserting Cart Details.\"}";  
		 ...
		 { 
			...
			{ 
				...
				{ 
					...
					output += "<tr><td><input id='hidTIDUpdate'name='hidTIDUpdate'type='hidden' value='" + cartid+ "'>" 
							+ pid + "</td>";
					output += "<td>" + type + "</td>"; 
					output += "<td>" + pname + "</td>"; 
					output += "<td>" + price + "</td>"; 
		...
		{ 
			 ...
			 { 
				 output = "{\"status\":\"error\", \"data\":\"Error while deleting Cart Details.\"}";
			 System.err.println(e.getMessage()); 
			 } 
			 return output; 
			 }
