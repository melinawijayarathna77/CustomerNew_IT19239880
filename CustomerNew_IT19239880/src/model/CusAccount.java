...
public class CusAccount {
	...
	// execute the statement
			...
			con.close(); 
			String newCustomers = readAccountDetails();
		...
		{ 
			output = "{\"status\":\"error\", \"data\":\"Error while inserting Customer Details.\"}"; 
	 ...
	 { 
		...
		{ 
			...
			{ 
				...
				// buttons
				output += "<td><input name='btnUpdate'type='button' value='Update'class='btnUpdate btn btn-secondary'></td>"+ "<td><input name='btnRemove'type='button' value='Remove'class='btnRemove btn btn-danger'data-cid='"
				+ cid + "'>" + "</td></tr>";
	...
	{ 
		 ...
		 { 
			 output = "{\"status\":\"error\", \"data\":\"Error while deletting Customer Details.\"}"; 
			 System.err.println(e.getMessage()); 
		 } 
		 return output; 
		 }
